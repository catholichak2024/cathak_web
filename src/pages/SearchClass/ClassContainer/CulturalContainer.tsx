...
const CulturalContainer: React.FC<CulturalContainerProps> = ({ data }) => {
    return (
        <S.Layout>
            <S.ClassBox>
                {data.map((item) => (
...
// const CulturalContainer: React.FC = () => {
...
//             try {
//                 const response = await fetch('http://13.125.38.246:3000/EveryGrade/search?type=교양', {
//                     method: 'GET',
//                     headers: {
