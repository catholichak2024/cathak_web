...
const MajorFoundationContainer: React.FC = () => {
    ...
    useEffect(() => {
        const fetchClassData = async () => {
            ...
            try {
                const response = await fetch('http://13.125.38.246:3000/EveryGrade/search?type=', {
                    method: 'GET',
                    headers: {
...
export default MajorFoundationContainer;
